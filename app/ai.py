...
_IMAGE_DESCRIPTION_PROMPT = (
    "Статичное изображение. Опиши видимое: объекты, людей, позы/действия, обстановку, стиль, эмоции, "
    "надписи. Один цельный краткий текст, только описание."
)

_STICKER_DESCRIPTION_PROMPT = (
    "Telegram-стикер или мем-картинка. Опиши видимое: персонажа/объект, мимику, позу, стиль, "
    "надписи, мемный смысл. Один цельный краткий текст, только описание."
)

_VIDEO_DESCRIPTION_PROMPT = (
    "Видео, анимация или видеокружок. Опиши видимое и слышимое по порядку: события, людей/объекты, "
    "действия, обстановку, надписи, речь, звуки. Если речь плохо слышна, укажи это. Один цельный "
    "краткий текст, только описание."
)

_AUDIO_DESCRIPTION_PROMPT = (
    "Только аудио. Опиши слышимое: речь кратким транскриптом или пересказом с ключевыми фразами "
    "в кавычках, тон, эмоции, паузы, смех, фоновые звуки. Если речь плохо слышна, укажи это. "
    "Только описание слышимого."
)
