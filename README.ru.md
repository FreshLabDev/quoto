...
9. Если день признан скучным, бот отправляет boring-day сообщение со ссылкой `Подробнее`
...
OPENROUTER_EVAL_REASONING_EFFORT=high
...
`/quote` теперь доступен только администраторам и показывает AI-preview. `/publish_quote` нужен администраторам, если автоматический запуск пометил день как скучный или упал с ошибкой.
